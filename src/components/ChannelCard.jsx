...
const ChannelCard = ({channelDetail ,marginTop}) => {
  ...
  return (
    ...
    <Box sx={{ boxShadow: 'none', borderRadius: '20px', display:'flex', justifyContent:'center', alignItems:'center', width:{xs:'356px' ,md:'320px'},margin:'auto', height:'326px', marginTop}}>
